...
data() {
		return {
			...
			dateend: moment(new Date(moment(new Date()).add(1, 'days'))).format('YYYY-MM-DD'),
			totaldays: 1,
...
<form method="get" @submit.prevent="addLeave">
	...
	<div class="col-md-12">
		<div class="mdb-form-field form-group-limit">
			<div class="form-field__control">
				<input type="text"  v-mask="'####-##-##'"  :value="datefiled" v-validate="'required|date_format:YYYY-MM-DD'" class="form-field__input" name="datefiled" readonly="readonly">
	...
	<div class="col-md-4">
				<div class="form-group-limit">
						<input type="text"  v-mask="'####-##-##'" v-model="datestart" v-validate="'required|date_format:YYYY-MM-DD'" class="form-field__input" name="date start" >
						<label class="form-field__label">Date Start (YYYY-MM-DD)</label>
						<div class="form-field__bar"></div>
				</div>
				<span class="errors">{{ errors.first('date start') }}</span>
	</div>
	<div class="col-md-4">
				<div class="form-group-limit">
						<input type="text"  v-mask="'####-##-##'" v-model="dateend" v-validate="'required|date_format:YYYY-MM-DD'" class="form-field__input" name="date end" >
						<label class="form-field__label">Date End (YYYY-MM-DD)</label>
						<div class="form-field__bar"></div>
				</div>
				<span class="errors">{{ errors.first('date end') }}</span>
	</div>
	<div class="col-md-4">
			<div class="mdb-form-field form-group-limit">
				<div class="form-field__control">
