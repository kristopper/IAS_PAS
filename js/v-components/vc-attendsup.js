// BRANCH ENTRY
Vue.component('attendancesup-form', {
props: ['userinfo'],
data: function () {
	return {
...
<div>
                                ...
                                <td>
                                    <div class="mdb-form-field form-group-limit">
                                        <div class="form-field__control form-field--is-filled">
                                            <input type="time" name="starttime" v-model="starttime" v-validate="'is_time|required'" class="form-field__input inline-input" >
    ...
    <div class="col-md-4">
        <div class="mdb-form-field form-group-limit">
            <div class="form-field__control">
                <input type="text" class="form-field__input" name="idno">
    ...
    <div class="col-md-4">
        <div class="mdb-form-field form-group-limit">
            <div class="form-field__control">
                <input type="text" class="form-field__input" name="descripancy-date">
    ...
    <div class="col-md-12">
        <div class="mdb-form-field ">
            <div class="form-field__control">
                <input type="text" class="form-field__input" v-validate="'required'" name="witnesses">
                <label class="form-field__label">Witnesses</label>
                <div class="form-field__bar"></div>
